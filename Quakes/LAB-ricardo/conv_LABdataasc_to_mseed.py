...
def con_dataasc_mseed(event_no, delta, motion, taper, taper_fac):
	...
	import datetime
	import time
	os.chdir('/Users/vidale/Documents/PyCode/LAB/ricardo/processed-data/' + event_no)
...
#			st_vz.taper(0.3)
	...
	#st_z.append(st_e[0])
	if motion == 'disp':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_data/disp/'
	elif motion == 'vel':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_data/vel/'
	elif motion == 'acc':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_data/acc/'
	else:
