...
#		print('Event ' + str(ev_lat) + ' ' + str(ev_lon) + ' station ' + split_line[4] + ' ' + split_line[5] + ' distance ' + str(distance[0]))
	...
	fname_dat       = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_data/'            + motion_pre + '/' + comp_pre + '_' + event_no + '.mseed'
	fname_synH      = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/' + motion_pre + '/cvmhy/'       + comp_pre + '_' + event_no + '_cvmhy.mseed'
	fname_synS      = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/' + motion_pre + '/cvms426-223/' + comp_pre + '_' + event_no + '_cvms426-223.mseed'
	fname_synH_simp = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/' + motion_pre + '/cvmhn/'       + comp_pre + '_' + event_no + '_cvmhn.mseed'
	fname_synS_simp = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/' + motion_pre + '/cvms400-100/' + comp_pre + '_' + event_no + '_cvms400-100.mseed'
