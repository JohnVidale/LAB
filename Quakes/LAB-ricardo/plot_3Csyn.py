...
def p_3Csyn(event_no, start_buff, end_buff, taper, taper_frac,
			plot_scale_fac, filt, freq_min, freq_max, min_dist, max_dist,
			vmodel, basin_width, basin, CI_only):
...
#	plt.title(fname1[8:18] + ' vs ' + fname2[8:18])
	plt.title('Syn ' + date_label + ' ' + event_no + ' E-black N-green Z-red of vmodel ' + vmodel)
	plt.show()
