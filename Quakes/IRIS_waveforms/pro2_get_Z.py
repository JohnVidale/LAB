...
#	select_event = 15
	...
	fname = 'event' + str(select_event) + '/event' + str(select_event) + 'Z_all.mseed'
...
#		if tr.stats.network != 'CE' and not (tr.stats.station == 'BVH' and tr.stats.channel == 'EHZ'):
	...
	fname = 'event' + str(select_event) + '/event' + str(select_event) + 'Z_decon.mseed'
	st.write(fname,format = 'MSEED')
	...
	fname = 'event' + str(select_event) + '/event' + str(select_event) + 'Z_chosen.mseed'
