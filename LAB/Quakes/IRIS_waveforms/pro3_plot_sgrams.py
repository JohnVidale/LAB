...
def plot_sgrams(select_event=0, filt = 1, freqmin = 0.05, freqmax = 1.0, component = 'Z'):
	import os
...
#%% stations to exclude
	...
	bad_sta = ['BVH','LAX','KIK','CAC','24851','14405','24400','WTT2']
...
#	bad_loc = []
	...
	st = Stream()
	fname = '/Users/vidale/Documents/PyCode/LAB/Pydata/event' + str(select_event) + '/event' + str(select_event) + component + '_chosen.mseed'
	st = read(fname)
