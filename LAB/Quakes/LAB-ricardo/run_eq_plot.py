...
os.chdir('/Users/vidale/Documents/GitHub/LAB-quakes/LAB-ricardo')
...
#			  plot_scale_fac = plot_scale_fac, filt = filt, freq_min = freq_min, freq_max = freq_max, min_dist = min_d, max_dist = max_d,
#			  vmodel = 'H', basin_width = basin_width, basin = basin)
...
os.chdir('/Users/vidale/Documents/PyCode/LAB/ricardo')
