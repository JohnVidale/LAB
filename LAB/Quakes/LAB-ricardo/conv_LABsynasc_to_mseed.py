...
def con_synasc_mseed(event_no, vmodel, delta, motion):
	...
	os.chdir('/Users/vidale/Documents/PyCode/LAB/ricardo/spare_files/synthetics/' + event_no + '/outputfiles/stations/'+ vmodel)
	delta = 0.1
...
#			print('station ' + st_name[cnt] + ' ' + ' st_num ' + labelcnt + ' cnt ' + str(cnt))
	...
	if motion == 'disp':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/disp'
	elif motion == 'vel':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/vel'
	elif motion == 'acc':
		pathn = '/Users/vidale/Documents/PyCode/LAB/ricardo/Mseed_syn/acc'
	else:
